...
JOB_RUNNER_CLS = "job_runner.GCNTrainSPGNN"
TEST_RUNNER_CLS = "job_runner.GCNTestSPGNN"
PLOT_EMBEDDING_CLS = "job_runner.PlotEmbeddingsSPGNN"
EXP_NAME = "pgat_lspe_3"
...
TRAIN_STITCHES_PATCH_SIZE = [(80, 80, 80), (80, 80, 80)]
TEST_STITCHES_PATCH_SIZE = [(80, 80, 80), (80, 80, 80)]
...
# model settings.
MODEL = {
    "method": "models.GATPositionSPGNNNet",
    "n_layers": 3,
    ...
    # "in_ch_list": [1, 4, 8, 16],
    # "base_ch_list": [2, 4, 8, 16],
    # "end_ch_list": [4, 8, 16, 32],
