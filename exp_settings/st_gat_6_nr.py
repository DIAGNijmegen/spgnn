...
JOB_RUNNER_CLS = "apps.airways.labeling_base.job_runner.GCNTrain"
TEST_RUNNER_CLS = "apps.airways.labeling_base.job_runner.GCNTest"
EXP_NAME = "gat_6_2_nr"

RESAMPLE_MODE = "iso_minimal"
...
MODEL = {
    ...
    "feat_drop": 0.1,
    "attn_drop": 0.1,
    "num_hiddens": [256, 128, 64, 64, 64, 64],
    "negative_slope": .2,
    "res":False
}
