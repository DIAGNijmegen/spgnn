...
#RELOAD_DICT_LIST = ["model_dict", "optimizer_dict", "scheduler_dict"]
...
JOB_RUNNER_CLS = "job_runner.GCNTrainLSPE"
TEST_RUNNER_CLS = "job_runner.GCNTestLSPE"
PLOT_EMBEDDING_CLS = "job_runner.PlotEmbeddingsLSPE"
EXP_NAME = "pgat_lspenl_3"
...
# model settings.
MODEL = {
    "method": "models.GATPositionLSPENet",
    "n_layers": 3,
